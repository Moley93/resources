...
Config = {
	...
	Products = {
		...
		["bar"] = {
			{ name = "water_bottle", price = 15, amount = 50, },
			{ name = "beer", price = 10, amount = 50, },
			{ name = "whiskey", price = 15, amount = 50, },
		...
		["hardware"] = {
			...
			{ name = "repairkit", price = 400, amount = 50,  requiredJob = { ["mechanic"] = 0, ["police"] = 0 } },
			{ name = "wateringcan", price = 50, amount = 50, },
			{ name = "screwdriverset", price = 550, amount = 50, },
			{ name = "phone", price = 1150, amount = 50, },
			{ name = "radio", price = 450, amount = 50, },
			{ name = "binoculars", price = 200, amount = 50, },
			{ name = "firework1", price = 500, amount = 50, },
			{ name = "firework2", price = 500, amount = 50, },
			{ name = "firework3", price = 500, amount = 50, },
			{ name = "firework4", price = 500, amount = 50, },
		...
		["weedshop"] = {
			...
			{ name = "rollingpaper", price = 10, amount = 1000, },
		},
		["gearshop"] = {
			{ name = "diving_gear", price = 10000, amount = 10, },
			{ name = "jerry_can", price = 200, amount = 50, },
		},
		["leisureshop"] = {
			{ name = "parachute", price = 10000, amount = 10, },
			{ name = "binoculars", price = 400, amount = 50, },
			{ name = "diving_gear", price = 10000, amount = 10, },
		},
		["weapons"] = {
			{ name = "weapon_knife", price = 2500, amount = 250, },
			{ name = "weapon_bat", price = 2500, amount = 250, },
			{ name = "weapon_hatchet",price = 2500, amount = 250,  requiredJob = { ["mechanic"] = 0, ["police"] = 0 } },
			{ name = "weapon_pistol", price = 15000, amount = 5, requiresLicense = true },
			{ name = "weapon_snspistol", price = 10000, amount = 5, requiresLicense = true },
			{ name = "weapon_vintagepistol", price = 8000, amount = 5, requiresLicense = true },
			{ name = "pistol_ammo", price = 250, amount = 250,  requiresLicense = true },
		},
		["coffeeplace"] = {
			{ name = "coffee", price = 25, amount = 500 },
			{ name = "lighter", price = 15, amount = 50 },
		},
		["casino"] = {
		...
		["electronics"] = {
			{ name = "phone", price = 1450, amount = 50 },
			{ name = "radio", price = 600, amount = 50, },
...
Config.Locations = {
    ...
    ["ammunation"] = {
        ...
        ["coords"] = {
            vector4(813.52, -2155.15, 29.62, 356.28),
            vector4(-659.13, -939.42, 21.83, 86.4),
			vector4(1697.64, 3757.82, 34.71, 137.39),
            vector4(-326.48, 6081.68, 31.45, 133.54),
			vector4(247.34, -51.49, 69.94, 339.33),
			vector4(18.02, -1107.98, 29.8, 160.2),
            vector4(2564.83, 298.24, 108.73, 275.19),
            vector4(-1112.79, 2697.52, 18.55, 132.1),
            vector4(841.12, -1029.06, 28.19, 266.21),
			vector4(-1310.26, -394.59, 36.7, 348.41),
		},
