...
-- NOS STUFF
	...
	NosTopSpeed = 20.0, -- Enabling this adds a multiplier to the top speed of the vehicle
...
--DuctTape Controllers
	...
	JobRoles = { "r68mech", "ottomech", "paletomech", "eastcustoms" }, -- These are the job roles who can use items if RequiresJob is enabled.
