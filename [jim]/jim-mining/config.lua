...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['emerald_ring_silver'] = 65,
		['ruby_ring_silver'] = 65,
		['sapphire_ring_silver'] = 65,

		['diamond_necklace'] = 85,
		['emerald_necklace'] = 85,
		['ruby_necklace'] = 85,
		['sapphire_necklace'] = 85,
		['diamond_necklace_silver'] = 40,
		['emerald_necklace_silver'] = 40,
		['ruby_necklace_silver'] = 40,
		['sapphire_necklace_silver'] = 40,

		['diamond_earring'] = 125,
		['emerald_earring'] = 125,
		['ruby_earring'] = 125,
		['sapphire_earring'] = 125,
		['diamond_earring_silver'] = 65,
		['emerald_earring_silver'] = 65,
		['ruby_earring_silver'] = 65,
		['sapphire_earring_silver'] = 65,
...
--Mining Store Items
	Items = {
		...
		items = {
			...
			{ name = "weapon_flashlight", price = 1000, amount = 100, info = {}, type = "item", slot = 4, },
