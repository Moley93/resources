...
Citizen.CreateThread(function()
  ...
  Citizen.Wait(1)
    SetRP()
    SetDiscordRichPresenceAssetText('https://discord.gg/hNBq8KgtvF')
      players = {}
      for i = 0, 128 do
          if NetworkIsPlayerActive( i ) then
              table.insert( players, i )
    ...
    SetDiscordRichPresenceAction(0, "Discord!", "https://discord.gg/hNBq8KgtvF")
    SetDiscordRichPresenceAction(1, "FiveM!", "fivem://connect/147.189.170.236:30120")
end
end)