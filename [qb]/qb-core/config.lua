...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 2500, bank = 0, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 4.8 -- Rate at which hunger goes down.
...
QBConfig.Server.Discord = "https://discord.gg/near-reality" -- Discord invite link
