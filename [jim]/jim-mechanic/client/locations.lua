...
Config.Locations = {
	...
	{	job = "eastcustomsmech",
		zones = {
			vector2(873.05, -2095.81),
			vector2(917.37, -2098.74),
			vector2(914.24, -2134.87),
			vector2(870.02, -2130.99)
		},
		stash = { { coords = vector3(901.23, -2104.0, 30.46), w = 0.6, d = 3.6, heading = 0.0 }, },
		...
		clockin = { { coords = vector3(876.39, -2100.43, 30.48), heading = 86.0, }, },
		nosrefill = { { coords = vector4(911.69, -2099.9, 30.46, 351.97) } },
		garage = { spawn = vector4(848.58, -2130.43, 30.54, 264.41),
					out = vector4(847.57, -2126.67, 30.54, 262.49),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" } },
		payments = { coords = vector3(875.06, -2100.24, 30.48), heading = 195.0, img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png width=150px></p>" },
		blip = vector3(892.15, -2113.27, 30.46),
		bliplabel = "Smith Customs",
		blipcolor = 81,
		discordlink = "",
		discordcolour = 2571775,
		discordimg = "https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png",
