local Translations = {
    ...
    info = {
		...
		['go_to_the_next_point_the_speed_limit_is_x_kmh'] = 'Go to the next point! Speed Limit: %{speed}km/h',
		...
		['hway_time'] = 'It is time for the highway! Do not drive to fast. The current Speed Limit is: %{speed}km/h ',
        ...
        ['questionlist4b'] = 'Move ot the right lane and stop',
