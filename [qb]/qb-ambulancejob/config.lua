...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["duty"] = {
        [1] = vector3(310.51, -597.02, 43.28),
    },
    ["vehicle"] = {
        [1] = vector4(297.75, -605.13, 43.24, 66.9),
        [2] = vector4(299.0, -602.19, 43.21, 68.05),
        [3] = vector4(296.93, -607.97, 43.26, 65.95),
        [3] = vector4(296.05, -611.08, 43.26, 66.39),
    },
    ["helicopter"] = {
        [1] = vector4(351.58, -587.45, 74.16, 160.5),
    },
    ["armory"] = {
        [1] = vector3(310.23, -603.01, 43.28),
    },
    ["roof"] = {
    ...
    ["stash"] = {
        [1] = vector3(306.31, -601.65, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(322.6, -587.01, 43.11, 336.32), taken = false, model = 1631638868},
        [2] = {coords = vector4(359.51, -586.12, 43.11, 366.35), taken = false, model = 1631638868},
        [3] = {coords = vector4(317.78, -585.28, 43.1, 336.32), taken = false, model = 2117668672},
        [4] = {coords = vector4(314.44, -584.2, 43.1, 336.32), taken = false, model = 2117668672},
        [5] = {coords = vector4(311.14, -582.91, 43.1, 336.32), taken = false, model = 2117668672},
        [6] = {coords = vector4(307.81, -581.75, 43.02, 336.32), taken = false, model = -1091386327},
        [7] = {coords = vector4(309.38, -577.48, 43.02, 152.08), taken = false, model = -1091386327},
