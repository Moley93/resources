...
Config = {
	...
	Products = {
		...
		["hardware"] = {
			...
			{ name = "fitbit", price = 700, amount = 150, },
		...
		["gearshop"] = {
			{ name = "diving_gear", price = 5000, amount = 10, },
		...
		["coffeeplace"] = {
			{ name = "coffee", price = 10, amount = 500 },
			{ name = "lighter", price = 15, amount = 50 },
		},
		["casino"] = {
		...
		["electronics"] = {
			{ name = "phone", price = 1150, amount = 50 },
			{ name = "radio", price = 400, amount = 50, },
			{ name = "screwdriverset", price = 600, amount = 50, },
			{ name = "binoculars", price = 200, amount = 50, },
			{ name = "fitbit", price = 700, amount = 150, },
		},
		["vending"] = {
